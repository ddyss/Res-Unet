...
class Net(nn.Module):
    def __init__(self,input_channel,base_channel=32):
        super(Net, self).__init__()
        self.skip_top = skip(input_channel,1)
        self.conv1_1 = Singleconv2d(input_channel,base_channel)
        self.conv1_2 = Singleconv2d(base_channel, base_channel)
        ...
        self.conv2_2 = Singleconv2d(base_channel*2, base_channel * 2)
        ...
        self.conv3_2 = Singleconv2d(base_channel * 4, base_channel * 4)
        ...
        self.conv4_2 = Singleconv2d(base_channel * 8, base_channel * 8)
        ...
        self.conv9_2 = Singleconv2d(base_channel * 16, base_channel * 16)
        ...
        # self.conv10_2 = Singleconv2d(base_channel * 32, base_channel * 32)
        self.skip10_11 = skip(base_channel * 32, base_channel * 32)
        #decoded
        self.conv11_1 = Singleconv2d(base_channel * 32, base_channel * 32)
        # self.conv11_2 = Singleconv2d(base_channel * 32, base_channel * 32)
        ...
        self.conv12_2 = Singleconv2d(base_channel * 16, base_channel * 16)
        ...
        self.conv5_1 = Singleconv2d(base_channel * 16 + base_channel * 8, base_channel * 8)
        self.conv5_2 = Singleconv2d(base_channel * 8, base_channel * 8)
        ...
        self.conv6_1 = Singleconv2d(base_channel * 8 + base_channel * 4, base_channel * 4)
        self.conv6_2 = Singleconv2d(base_channel * 4, base_channel * 4)
        self.up2 = nn.Upsample(scale_factor=2)
        # self.skip68 = decoded_skip_abd4(base_channel * 4, base_channel * 4)

        self.conv7_1 = Singleconv2d(base_channel * 4 + base_channel * 2, base_channel * 2)
        self.conv7_2 = Singleconv2d(base_channel * 2, base_channel * 2)
        self.up1 = nn.Upsample(scale_factor=2)

        self.conv8_1 = Singleconv2d(base_channel * 2 + base_channel, base_channel)
        self.conv8_2 = Singleconv2d(base_channel, base_channel)

        # self.convfinal = Singleconv2d(base_channel, 1)
        self.convfinalpre = Singleconv2d(base_channel, base_channel//2)
        self.convfinal = Singleconv2d(base_channel//2 + 1, 1)
    def forward(self, x):
        identity = x
        ...
        x_5 = self.conv5_2(self.conv5_1(torch.cat([x_up4, x_s45], 1)))
        x_up3 = self.up3(x_5)
        # x_s57 = self.skip57(x_5)
        # x_s58 = self.skip58(x_5)

        x_6 = self.conv6_2(self.conv6_1(torch.cat([x_up3, x_s36], 1)))
        x_up2 = self.up2(x_6)
        # x_s68 = self.skip68(x_6)

        x_7 = self.conv7_2(self.conv7_1(torch.cat([x_up2, x_s27], 1)))
        x_up1 = self.up1(x_7)

        x_8 = self.conv8_2(self.conv8_1(torch.cat([x_up1,x_s18], 1)))

        s_top = self.skip_top(identity)
        x_8 = self.convfinalpre(x_8)
        out = self.convfinal(torch.cat([x_8,s_top],1))
